...
tf.app.flags.DEFINE_integer('report_freq', 63, '''Steps takes to output errors on the screen
and write summaries''')
...
tf.app.flags.DEFINE_integer('padding_size', 8, '''In data augmentation, layers of zero padding on
each side of the image''')


## If you want to load a checkpoint and continue training

tf.app.flags.DEFINE_string('ckpt_path', 'logs_kkk/model.ckpt-40000', '''Checkpoint
